...
- [[#user-interface][User interface]]
  ...
  - [[#buffer-management-ibuffer][Buffer management (ibuffer)]]
  - [[#fonts-and-themes][Fonts and themes]]
  - [[#customization-helper][Customization helper]]
  - [[#window-management-ace-window][Window management (ace-window)]]
  - [[#hydra][Hydra]]
  - [[#ivy][Ivy]]
  - [[#popwin][Popwin]]
  - [[#sr-speedbar][SR-Speedbar]]
  - [[#return-focus-to-minibuffer][Return focus to minibuffer]]
...
The package I work on are on my =Code= folder, and we need to load them from here:
