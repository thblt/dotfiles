...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-text-mode ()
    "text-mode switches"
    ("f" flyspell-mode "Flyspell" :exit t)
    ("l" ispell-change-dictionary "Language" :exit t)
    ("w" writeroom-mode "Writeroom" :exit t)
    ("=" writeroom-increase-width "Increase width")
    ("-" writeroom-decrease-width "Decrase width"))
...
#+begin_src emacs-lisp
  (use-package projectile
    ...
    (define-prefix-command 'thblt-projectile-map)
