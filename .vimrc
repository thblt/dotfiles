...
" -- Haskell
Plugin 'Shougo/vimproc.vim'                " Required by ghcmod-vim
Plugin 'Twinside/vim-hoogle'               " Hoogle search
Plugin 'eagletmt/ghcmod-vim'               " ghc-mod lint and check
Plugin 'eagletmt/neco-ghc'                 " ghc completion provider
Plugin 'neovimhaskell/haskell-vim'         " Syntax and indentation
" -- Jade
...
if has("macvim")
	let $PATH = $PATH . ':' . expand('~/.cabal/bin') " Fix path
endif
