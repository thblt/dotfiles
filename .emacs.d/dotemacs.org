...
If we're running on a HiDPI machine (we can't really do better than that, we replace the flycheck fringe bitmap with a larger version.)
...
TODO [[https://github.com/DarthFennec/highlight-indent-guides/issues/23][Waiting for a fix]].  Uncomment line 2 when released.
