...
#+begin_src emacs-lisp
  (setq magit-repolist-columns '(
                                 ...
                                 ("L<U" 5 magit-repolist-column-unpulled-from-upstream
                                  ((:right-align t)))
                                 ("L>U" 5 magit-repolist-column-unpushed-to-upstream
                                  ((:right-align t)))
                                 ("Test" 15 magit-repolist-column-unpushed-to-pushremote)
                                 ("Test'" 15 magit-repolist-column-unpulled-from-pushremote)
